...
export default class RabobankPopUpScene extends Scene {
  ...
  public constructor(maxX: number, maxY: number) {
    ...
    if (Stats.selectedLanguage == 'Dutch') {
      this.image.src = 'assets/ChatPopUps/Q_NL_Rabobank.jpg';
    } else {
      this.image.src = 'assets/ChatPopUps/Q_EN_Rabobank.jpg';
    }
  }
  ...
  public override nextScene(): Scene {
    if(this.goToNextScene == true){
      return new SceneBathroom(this.maxX, this.maxY, 0, 0);
    }
    return this;
  }
  ...
  public override update(): void {
    if (this.chooseYes == true) {
      if (Stats.selectedLanguage == 'Dutch') {
        this.image.src = 'assets/ChatPopUps/Answers/Y_NL_Rabobank.png';
      } else {
        this.image.src = 'assets/ChatPopUps/Answers/Y_EN_Rabobank.png';
      }
    }
    if (this.chooseNo == true) {
      if (Stats.selectedLanguage == 'Dutch') {
        this.image.src = 'assets/ChatPopUps/Answers/N_NL_RabobankRev1.png';
      } else {
        this.image.src = 'assets/ChatPopUps/Answers/N_EN_Rabobank.png';
      }
    }
  }
